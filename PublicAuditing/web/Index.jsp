<%-- 
    Document   : Aboutus
    Created on : nov 1, 2018, 5:57:29 PM
    Author     : Sivaa Prasannaa
--%>
...
<div class="wrapper"> 
  ...
  <div class="header">
    <div class="header-container">
      <div class="logo"> <a href="#"> Privacy Preserving  Public Auditing for Shared Data in the Cloud</a> </div>
      <div class="toll-free">
    ...
    <div class="nav-in">
      <ul>
        <li class="last">
            ...
            <li><a href="DataOwnerLogin.jsp"> </a></li>
            <li> <a href="Index.jsp">Home</a></li>        
        <li><a href="AdminLogin.jsp">Admin </a></li>
           
        <li><a href="AuditorLogin.jsp">Auditor Login </a></li>
  ...
  <div class="footer">
    <div class="footer-in">
      <div class="social-icons">
        <ul>
          <li><a href="#"><img src="images/face-book.png" width="24" height="24" alt="img" /></a></li>
          <li><a href="#"><img src="images/twitter.png" width="24" height="24" alt="img" /></a></li>
          <li class="last"><a href="#"><img src="images/google.png" width="24" height="24" alt="img" /></a></li>
        </ul>
        <div class="clear"></div>
      </div>
      <div class="copy">
          <div align="center">
              <p><h3>&copy; Sivaa Prasannaa 2018</h3></p>
          </div>
      </div>
      <div class="clear"></div>
    </div>
